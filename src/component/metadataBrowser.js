      ...
      <Box sx={{ p: 2, maxWidth: 760 }}>
        ...
        <Box sx={{ fontFamily: 'monospace', fontSize: 13, whiteSpace: 'pre-wrap' }}>
          {[
            ...
            'type:finding/vulnerability data.severity>=HIGH',
            'type:finding/vulnerability data.severity>=3',
            'Symbolic severity comparisons require exactly one finding type.',
            '',
            'Finding type:',
            ...
            'meta.creation_date>=2025-01-01T00:00:00Z',
